                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                        	...
                        	</c:if> <!--janela de mensagem - livro cadastrado com sucesso-->
                                ...
                                <form method="post" action="/admin/livro/novo" >
                                    <input type="hidden" name="id" value="${id}">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
														...
														<input class="form-control" id="titulo" name="titulo" value="${titulo}" type="text" placeholder="Título Completo" />
													</div>
                                                </div>
                                            ...
                                            <div class="form-group">
												...
												<input class="form-control" id="autor" type="autor" name="autor" value="${autor}" aria-describedby="emailHelp" placeholder="Informe o autor" /></div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
